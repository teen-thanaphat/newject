...
function Materialadd() {
  ...
  //comapny
  const [company, setCompany] = useState([{ company_Id: 1, company_name: 'Company A' }, { company_Id: 2, company_name: 'Company B' }]); //ตัวอย่างข้อมูลบริษัท
    ...
    <div className="Appcontainer">
      <div className="add">
        <form onSubmit={saveMaterial}>
          ...
          <p>(วัน/เดือน/ปี) : {formattedDate}</p>
          ...
          <p>(วัน/เดือน/ปี) : {formattedDate2}</p>
          <div className="field1">
